...
import generatedId from "./id-gen";

// Component will count number of new items added by user
export default function NewItem({ onAddItem, existingIds }) {
    // Name
    ...
    // Ensures generated ID is unique
    ...
    return (
        // Form element
        <form className="flex flex-col space-x-4 items-center w-80 ml-10 border rounded mb-5 pt-5 border-sky-100">
            {/* Name input field */}
            <div className="mb-10">
                <input
                    type="text"
            ...
            <div>
                <button 
                    ...
                    className="mb-5 mt-10 px-4 py-2 bg-sky-100 text-black rounded"
                >
                    Add Item
                </button>
            </div>
